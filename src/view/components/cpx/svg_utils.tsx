...
namespace svg {
    ...
    export function mkPath(cls: string, data: string, title?: string): SVGPathElement {
        ...
        let el = svg.elt("path") as SVGPathElement;
        svg.hydrate(el, p);
        return el;
    }
    ...
    //     let gradient = svg.elt("linearGradient") as SVGLinearGradientElement;
    ...
    //     (lg.childNodes[0] as SVGStopElement).style.stopColor = start;
    //     (lg.childNodes[1] as SVGStopElement).style.stopColor = start;
    //     (lg.childNodes[2] as SVGStopElement).style.stopColor = end;
    //     (lg.childNodes[3] as SVGStopElement).style.stopColor = end;
    // }

    // export function setGradientValue(lg: SVGLinearGradientElement, percent: string) {
    //     if ((lg.childNodes[1] as SVGStopElement).getAttribute("offset") != percent) {
    //         (lg.childNodes[1] as SVGStopElement).setAttribute("offset", percent);
    //         (lg.childNodes[2] as SVGStopElement).setAttribute("offset", percent);
    //     }
    // }
