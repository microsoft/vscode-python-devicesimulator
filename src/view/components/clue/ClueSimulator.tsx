...
export class ClueSimulator extends React.Component<any, IState> {
    ...
    protected onKeyEvent(event: KeyboardEvent, active: boolean, key: string) {
        ...
        if ([event.code, event.key].includes(CONSTANTS.KEYBOARD_KEYS.ENTER) && this.context === VIEW_STATE.RUNNING
        ) {
            ...
            [event.code, event.key].includes(CONSTANTS.KEYBOARD_KEYS.A) && this.context === VIEW_STATE.RUNNING
        ) {
            ...
            [event.code, event.key].includes(CONSTANTS.KEYBOARD_KEYS.B) && this.context === VIEW_STATE.RUNNING
        ) {
            ...
            [event.code, event.key].includes(CONSTANTS.KEYBOARD_KEYS.C) && this.context === VIEW_STATE.RUNNING
        ) {
