...
class Display:
    ...
    def scroll(self, value, delay=150, wait=True, loop=False, monospace=False):
        ...
        telemetry_py.send_telemetry("MICROBIT_API_DISPLAY_SCROLL")
    ...
    def show(self, value, delay=400, wait=True, loop=False, clear=False):
        ...
        telemetry_py.send_telemetry("MICROBIT_API_DISPLAY_SHOW")
    ...
    def get_pixel(self, x, y):
        ...
        """
        telemetry_py.send_telemetry("MICROBIT_API_DISPLAY_OTHER")
        self.__lock.acquire()
    ...
    def read_light_level(self):
        ...
        """
        telemetry_py.send_telemetry("MICROBIT_API_LIGHT_LEVEL")
